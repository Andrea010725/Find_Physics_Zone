...
class GPT(nn.Module):
    ...
    def forward(
        ...
        yaw_pose_scale_token_embeddings = torch.cat(
            [input_yaw_token_embeddings, input_pose_x_token_embeddings, input_pose_y_token_embeddings, input_feature_embeddings],
        dim=2
        )
        ...
        for i in range(self.causal_time_space_num):
            ...
            if return_hidden_states:
                    ...
                    "stage": "time_space",
                    "layer_idx": i,
                    "tensor": time_space_token_embeddings.contiguous(),
                })
