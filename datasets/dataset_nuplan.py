...
class NuPlanTest(Dataset):
    def __init__(self, data_root, json_root, condition_frames=3, downsample_fps=5, downsample_size=16, h=256, w=512):
        ...
        self.meta_path = "/home/zhiwen/DrivingWorld/data/seq_meta/2021.05.12.22.28.35_veh-35_00620_01164.json"
        self.pose_meta_path = "/home/zhiwen/DrivingWorld/data/ego_meta"
